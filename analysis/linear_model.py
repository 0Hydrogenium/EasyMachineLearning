...
# Linear regression
def linear_regression(x_train_and_validate, y_train_and_validate, x_test, y_test, train_and_validate_data_list=None, hyper_params_optimize=None, model="LinearRegression"):
    """

    :param x_train_and_validate:
    :param y_train_and_validate:
    :param x_test:
    :param y_test:
    :param train_and_validate_data_list:
    :param hyper_params_optimize: grid_search, bayes_search
    :param model: LinearRegression, Lasso, Ridge, ElasticNet
    :return:
    """
    ...
    if hyper_params_optimize == "grid_search":
        best_model = grid_search(params, linear_regression_model, x_train_and_validate, y_train_and_validate)
    elif hyper_params_optimize == "bayes_search":
        best_model = bayes_search(params, linear_regression_model, x_train_and_validate, y_train_and_validate)
    else:
